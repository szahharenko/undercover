...
const GalleryByFolder: React.FC<{ mainImagesGlob: Record<string, unknown>, thumbsGlob: Record<string, unknown>, title: string, description: string }> = ({ mainImagesGlob, thumbsGlob, title, description }) => {
...
export default GalleryByFolder;
