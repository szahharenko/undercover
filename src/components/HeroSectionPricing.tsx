  ...
  return (
    ...
    >
      <div className="absolute w-full h-full z-1">
        <img src={pricing} alt="Coworking desks and ergonomic chairs at Undercover Vibe, Tallinn" className="w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
