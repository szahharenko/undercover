  ...
  return (
    ...
    >
      ...
      <div className="absolute w-full h-full z-1">
        <img src={founders} alt="Undercover Vibe founders - the team behind Tallinn's coziest coworking and board game club" className="w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
