      ...
      <div className="container mx-auto px-4 text-center">
        <div className="">
          <div className='flex items-center w-full justify-between max-w-[700px] mx-auto'>
            <img src={cat} alt="Undercover Vibe mascot cat illustration" className='max-h-[150px] h-auto' loading="lazy" decoding="async"/>
            ...
            <img src={dog} alt="Undercover Vibe mascot dog illustration" className='max-h-[150px] h-auto' loading="lazy" decoding="async"/>
          </div>
        </div>
