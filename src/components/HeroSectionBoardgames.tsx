...
import bgs from '../assets/bgparty.jpg';
  ...
  return (
    ...
    >
      <div className="absolute w-full h-full z-1">
        <img src={bgs} alt="Board game party night at Undercover Vibe in Tallinn" className="w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
